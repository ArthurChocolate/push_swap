...
/*
	ft_steps - marks each element, how many steps it needs 
	to take to get to the top of the stack
*/
...
/*
	ft_min_steps - the function finds an element that can be moved
	to the top in the minimum number of steps
*/
...
/*
	ft_start_sort - starts the sorting process
*/
...
/*
	ft_main_sort - sorting algorithm based on insertion sorting
*/
